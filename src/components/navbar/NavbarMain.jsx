...
const NavbarMain = () => {
  ...
  return(
    <nav className="max-w-[1300px] max-auto px-4 w-full fixed left-[50%] -translate-x-[50%] z-20 flex gap-4 mt-2">
        ...
        <div className='flex lg:hidden sm:block bg-black items-center justify-center rounded-full border-[0.5px] border-orange'>
            <button className='text-2pxl p-3 border border-orange rounded-full text-white' onClick={toggleMenu}>
                <GiHamburgerMenu />
            </button>
        </div>
    </nav>
